...
```xml
<link rel="stylesheet" href="https://cdn1.tianli0.top/npm/@fortawesome/fontawesome-free@6/css/all.min.css">
```
...
```xml
<script src="https://cdn1.tianli0.top/gh/stevenjoezhang/live2d-widget@latest/autoload.js"></script>
```
...
```xml
<script src="https://cdn1.tianli0.top/gh/username/live2d-widget@latest/autoload.js"></script>
```
